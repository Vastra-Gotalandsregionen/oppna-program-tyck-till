...
public class IncidentReportReaderTest extends TestCase {
    ...
    private String incidentReport1 = "<incidentReport>" + "<reportType>error</reportType>"
            + "<errorType>errorMessage</errorType>" + "<timestamp>2008-08-08 10:22:22:222</timestamp>"
            + "<browser>Mozilla</browser>" + "<defaultErrorMessage>defaultErrorMessage</defaultErrorMessage>"
            + "<description>description</description>" + "<feedback>" + "	<sendFeedback>true</sendFeedback>"
            + " 	<feedbackBySms activated=\"false\">" + "		<phoneNumber>070-666666</phoneNumber>"
            + "	</feedbackBySms>" + "	<feedbackByPhone activated=\"false\">"
            + "		<phoneNumber>070-555555</phoneNumber>" + "	</feedbackByPhone>"
            + "	<feedbackByMail activated=\"true\">" + "  		<email>john.doe@domain.com</email>"
            + "	</feedbackByMail>" + "</feedback>" + "<screenShot>" + "	<sendScreenShot>true</sendScreenShot>"
            + "	<files>" + "		<file filename=\"\" mediatype=\"\"/>" + "	</files>" + "</screenShot>	"
            + "</incidentReport>";

    private String incidentReport2 = "<incidentReport>"
